...
const Features = () => {
  return (
    <>
      ...
      <section>
        <div className="flex flex-col items-center w-full max-w-screen md:w-[95%] md:justify-around">
          <h1
            style={{
              fontFamily: "Mulish, sans-serif",
              fontWeight: "700",
          ...
          <div className="flex flex-wrap flex-row justify-around w-full">
            <div className="bg-slate-300 rounded-lg max-w-xs md:max-w-[30rem] 2xl:max-w-2xl w-full mt-3">
              <div className="w-full h-full mx-3 my-3">
                <h1
                  style={{
                    fontFamily: "Mulish, sans-serif",
                    fontWeight: "600",
                ...
                <p className="text-md">
                  Access our same professionals from the comfort of your home or
